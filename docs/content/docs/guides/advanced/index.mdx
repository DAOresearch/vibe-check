...
description: Master advanced vibe-check features including MCP server integration, cost optimization strategies, artifact cleanup policies, and multi-modal prompts with images and files.
---
