...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://daoresearch.github.io/vibe-check/og-images/api.png
  - tag: meta
    attrs:
...
:::tip[📋 Reference - Information-Oriented]
This section provides **accurate, factual technical information** about all functions, types, and interfaces. Documentation is comprehensive, precise, and structured for quick lookup.

**Looking for how to use these APIs?** See [Guides](/guides/) for practical examples.
**Want to understand the design?** See [Explanation](/explanation/) for architecture details.
