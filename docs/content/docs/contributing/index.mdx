...
- **[Architecture Overview](/explanation/architecture/)** - System design and internal implementation
- **[Development Setup](https://github.com/DAOresearch/vibe-check#development)** - Local dev environment
- **[Code Style Guide](/contributing/#code-style)** - Coding standards and patterns
...
Read [Architecture Overview](/explanation/architecture/) to understand how Vibe Check works internally:
...
- Browse [open issues](https://github.com/DAOresearch/vibe-check/issues)
- Look for `good-first-issue` or `help-wanted` labels
- Or propose a new feature in [discussions](https://github.com/DAOresearch/vibe-check/discussions)
...
- **Technical questions:** Open a [discussion](https://github.com/DAOresearch/vibe-check/discussions)
- **Bug reports:** Open an [issue](https://github.com/DAOresearch/vibe-check/issues)
- **Feature requests:** Start a [discussion](https://github.com/DAOresearch/vibe-check/discussions)
