...
**Location:** `.claude/` directory in this repository

:::note[Documentation Coming Soon]
Detailed guides for the scaffold system are being written. The code is already in `.claude/` and ready to use. Check the inline documentation in command files.
:::
...
See command files in `.claude/commands/` for examples.
...
See agent definitions in `.claude/agents/` for full options.
...
- **[Getting Started](/getting-started/)** - Learn how to use Vibe Check
