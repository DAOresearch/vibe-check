...
description: Complete Claude Code scaffold with templates, workflows, and specialized agents
---
...
### [Scaffold System](/claude-code/scaffold/)
...
### [GitHub Workflows](/claude-code/workflows/)
...
### [Task Templates](/claude-code/templates/)
...
### [Specialized Agents](/claude-code/agents/)
...
See [Workflows Guide](/claude-code/workflows/) for detailed setup.
...
- **[Scaffold System](/claude-code/scaffold/)** - Complete scaffold reference
- **[Workflows Guide](/claude-code/workflows/)** - GitHub workflow setup and usage
- **[Templates](/claude-code/templates/)** - Task template system
- **[Agents](/claude-code/agents/)** - Specialized agent configuration
