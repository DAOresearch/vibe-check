...
description: Benchmark your first agent in 5 minutes
sidebar:
  order: 6
---
...
- **[Benchmarking Guide](/guides/evaluation/benchmarking/)** - Advanced benchmarking patterns
...
- **[Custom Matchers](/api/matchers/)** - All available assertions
...
[← Back to Getting Started](./) | [Previous: First Automation](/getting-started/first-automation/)
